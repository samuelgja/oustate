...
- **react-scope**<br/>
  ...
  There is fix around it and it's third parameter in hooks - equality check. Also there can be used third party libraries to equality check object like [react-fast-compare](https://github.com/FormidableLabs/react-fast-compare).
