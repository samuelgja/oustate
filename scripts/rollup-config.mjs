...
const externalLibs = ['react', 'react-dom', 'react-native', 'recoil', 'transit-js', 'relay-runtime', 'react-relay']
...
const commonPlugins = [
  ...
  alias({
    entries: [
      {
        find: 'recoil-shared',
        replacement: path.resolve(rootDirectory, 'packages/shared'),
      },
      // temporarily bundle refine into recoil-sync
      {
        find: 'refine',
        replacement: path.resolve(rootDirectory, 'packages/refine/Refine_index.js'),
      },
    ],
  }),
  nodeResolvePlugin,
